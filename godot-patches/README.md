...
The five commits that make the overlay work on Wayland, exported from
...
| 0005 | Binds layer-shell at protocol v4 and sets `keyboard_interactivity=on_demand`, so clicking a LineEdit actually receives keys instead of only drawing a focus ring |
